...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme which-key use-package powerline markdown-mode hl-todo expand-region color-theme-sanityinc-solarized ace-jump-mode)))
 '(save-place-mode t))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ace-jump-face-foreground ((t (:background "#073642" :foreground "#fdf6e3" :inverse-video nil)))))
