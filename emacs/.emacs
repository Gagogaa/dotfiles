...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets wrap-region which-key visible-mark use-package powerline material-theme hungry-delete hl-todo god-mode eziam-theme expand-region engine-mode eink-theme company color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized color-theme-ir-black clues-theme calmer-forest-theme busybee-theme boron-theme bliss-theme birds-of-paradise-plus-theme basic-theme badwolf-theme autumn-light-theme atom-one-dark-theme atom-dark-theme arjen-grey-theme apropospriate-theme anti-zenburn-theme ample-zen-theme ahungry-theme afternoon-theme ace-jump-mode abyss-theme))))
(custom-set-faces
